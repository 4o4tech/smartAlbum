...
public class imagePick extends WXModule{
        ...
        public void chooseImage(HashMap<String,Object> options, JSCallback callback){
            ...
            if (options.containsKey("sourceType")) {
                if ("album".equals(options.get("sourceType"))) {
                    pictureSelectionModel = PictureSelector.create((Activity) this.mWXSDKInstance.getUIContext()).openGallery(PictureMimeType.ofAll()).isCamera(false);
                } else {
                    pictureSelectionModel = PictureSelector.create((Activity) this.mWXSDKInstance.getUIContext()).openCamera(PictureMimeType.ofAll());
                }
            } else {
                pictureSelectionModel = PictureSelector.create( (Activity) this.mWXSDKInstance.getUIContext()).openGallery(PictureMimeType.ofAll());
            }
